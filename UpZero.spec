...
pushd cpp
./reconf
%define _bindir %{_prefix}/dom/components/UpZero/cpp
%configure
make %{?_smp_mflags}
popd
...
%{_prefix}/dom/components/%{name}/UpZero.scd.xml
%{_prefix}/dom/components/%{name}/UpZero.prf.xml
%{_prefix}/dom/components/%{name}/UpZero.spd.xml
